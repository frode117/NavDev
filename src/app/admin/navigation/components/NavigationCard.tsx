...
export function NavigationCard({ 
  ...
  const handleDoubleClick = () => {
    router.push(`/admin/navigation/${item.id}/categories`)
  }
    ...
    <Draggable draggableId={item.id} index={index}>
      {(provided, snapshot) => (
        <div
          ...
          className={`group flex items-center justify-between p-4 rounded-lg border bg-card text-card-foreground shadow-sm hover:border-primary/50 transition-colors cursor-pointer ${
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <TooltipProvider>
              {/* Top/Bottom buttons - leftmost, visible only on hover */}
