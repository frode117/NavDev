                      ...
                      {(provided) => (
                        ...
                        >
                          <div className="flex items-center justify-between py-2 px-4 bg-card rounded-lg border shadow-sm transition-colors hover:bg-accent/10">
                            ...
                            <div className="flex items-center gap-1">
                              {/* Top/Bottom buttons - leftmost, hover-only, aligned */}
                              <Button
                                variant="ghost"
                                size="icon"
                                className={cn(
                                  "h-8 w-8 transition-opacity",
                                  index === 0 ? "invisible pointer-events-none" : "opacity-0 group-hover:opacity-100"
                                )}
                              ...
                              <Button
                                ...
                                className={cn(
                                  "h-8 w-8 transition-opacity",
                                  index >= (category?.items?.length || 0) - 1 ? "invisible pointer-events-none" : "opacity-0 group-hover:opacity-100"
                                )}
