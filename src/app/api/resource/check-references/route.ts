...
export async function POST(request: Request) {
  try {
    ...
    // 获取导航数据
    const navigationData = await getFileContent('src/navdev/content/navigation.json') as NavigationData

    // 获取站点配置数据
    const siteData = await getFileContent('src/navdev/content/site.json') as SiteConfig
